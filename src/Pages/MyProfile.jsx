...
const MyProfile = () => {
  ...
  useEffect(() => {
    const apiCall = setTimeout(() => {
      axios.get("https://api.github.com/users/The-Anupam-Das").then((res) => setData(res.data));
      axios.get("https://api.github.com/users/The-Anupam-Das/repos").then((res) => setRepos(res.data));
    }, 1500);
